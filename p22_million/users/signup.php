...
<body>
<center class="page_header"><img src="<?php echo SITE_LOGO_URL; ?>"/> <br/>
      <h3 ><?php echo $label["advertiser_signup_heading1"]; ?></h3></center> 
<table width="60%" align="center" width="100%"  border="0" cellspacing="0" cellpadding="0" id="main_table" class="main_table">
	<tr class="sign_up_title">
