...
<table border="0" cellSpacing="1" cellPadding="3" bgColor="#d9d9d9" class="outgoing-mail" style="width:100%; margin-top: 20px">
			<tr bgColor="#eaeaea">
				<td><b><font size="3">Date</b></font></td>
				<td><b><font size="3">Type</b></font></td>
				<td><b><font size="3">To Addr</b></font></td>
				<td><b><font size="3">To Name</b></font></td>
				<td><b><font size="3">Fr Addr</b></font></td>
				<td><b><font size="3">Fr Name</b></font></td>
				<td><b><font size="3">Subj</b></font></td>
				<td><b><font size="3">Msg</b></font></td>
				<td><b><font size="3">Html Msg</b></font></td>
				<td><b><font size="3">Att</b></font></td>
				<td><b><font size="3">Status</b></font></td>
				<td><b><font size="3">Err</b></font></td>
				<td><b><font size="3">Retry</b></font></td>
				<td><b><font size="3">Action</b></font></td>
			</tr>
...
?>
	...
	<tr bgColor="#ffffff">
		<td><font size="2"><?php echo get_local_time($row['mail_date']); ?></font></td>
		<td><font size="2"><?php echo $row['template_id']; ?></font></td>
		<td><font size="2"><?php echo $row['to_address']; ?></font></td>
		<td><font size="2"><?php echo $row['to_name']; ?></font></td>
		<td><font size="2"><?php echo $row['from_address']; ?></font></td>
		<td><font size="2"><?php echo $row['from_name']; ?></font></td>
		<td><font size="2"><?php echo substr($row['subject'],0, 7); ?><a href="" <?php echo $new_window; ?>>...</a></font></td>
		<td><font size="2"><?php echo substr($row['message'],0, 7); ?><a href="" <?php echo $new_window; ?>>...</a></font></td>
		<td><font size="2"><?php echo substr($row['html_message'],0,7); ?><a href="" <?php echo $new_window; ?>>...</a></font></td>
		<td><font size="2"><?php echo $row['attachments']; ?></font></td>
		<td><font size="2" color="<?php if ($row['status']=='sent') { echo 'green'; } ?>"><?php echo $row['status']; ?></font></td>
		<td><font size="2"><?php echo $row['error_msg']; ?></font></td>
		<td><font size="2"><?php echo $row['retry_count']; ?></font></td>
		<td><b><font size="2"><a href='email_queue.php?action=resend&mail_id=<?php echo $row[mail_id].$q_string;?>'>Resend</a></b></font></td>
	</tr>
