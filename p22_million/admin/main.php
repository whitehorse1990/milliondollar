...
require_once("../include/dynamic_forms.php");
    ...
    $fancy_heading_style = "    display: block;
                                padding: 2px 10px;
                                margin: 2px;
                                border-style: solid;
                                border-color: #99CCCC;
...
<p align="left"><h3 style="<?php echo $fancy_heading_style;?>">Main Summary</h3></p>
	<span style="display: block; float: left; margin-bottom: 20px;"><font size='3'>Current GMT Time: <?php echo (gmdate("Y-m-d H:i:s")); ?></font></span>
	<table  width="80%" border="0" cellpadding="5" style="border-collapse: collapse; margin-top: 20px; margin: 0 auto">

	<tr>
	<td style="border-bottom-style: solid; border-bottom-width: 1"><a href="customers.php" style="text-decoration: none;">Advertiser Accounts</a></td>
	...
	<a href="orders.php?show=WA" style="text-decoration: none;"><?php if ($orders_waiting>0) echo "<b>"; ?>Orders Waiting<?php if ($orders_waiting>0) echo "</b>";?></a></td>
	<td style="border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1">
	<?php echo $orders_waiting;?></td>
	</tr>

	<tr>
	<td style="border-bottom-style: solid; border-bottom-width: 1" ><a href="orders.php?show=CA" style="text-decoration: none;">Orders Cancelled</a></td>
	<td style="border-bottom-style: solid; border-bottom-width: 1"><?php echo $orders_cancelled;?></td>
	</tr>
	<tr>
	<td style="width: 50%; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1">
	<a href="orders.php?show=CO" style="text-decoration: none;">Orders Completed</a> </td>
	<td style="border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1">
	<?php echo $orders_completed;?></td>
	</tr>

	<tr>
	<td style="border-bottom-style: solid; border-bottom-width: 1" ><a href="approve.php" style="text-decoration: none;">Pixels Waiting for approval</a></td>
...
function does_field_exist($table, $field) {
  ...
  PRIMARY KEY  (`lang_code`)) ";
	...
	if (!does_field_exist("form_fields", "field_id")) {
		...
		mysql_query($sql) or die ("<p><b>CANNOT UPGRADE YOUR DATABASE!<br>Please run the follwoing query manually from PhpMyAdmin:</b><br><pre>$sql</pre><br>");
        $sql = "INSERT INTO `form_fields` VALUES (1, 4, 1, '', 'Company Name', 'TEXT', 4, 'Y', '', '', 'was not filled in', '', 80, 0, 0, 0, 'ALT_TEXT', '', '', '', 0, '', 0, '', '', '')";
        mysql_query($sql) or die ("<p><b>CANNOT UPGRADE YOUR DATABASE!<br>Please run the follwoing query manually from PhpMyAdmin:</b><br><pre>$sql</pre><br>");
	...
	if (!does_field_exist("form_field_translations", "field_id")) {
		...
		mysql_query($sql) or die ("<p><b>CANNOT UPGRADE YOUR DATABASE!<br>Please run the follwoing query manually from PhpMyAdmin:</b><br><pre>$sql</pre><br>");
        $sql = "INSERT INTO `form_field_translations` VALUES (4, 'EN', 'Company Name', 'was not filled in', '')";
        mysql_query($sql) or die ("<p><b>CANNOT UPGRADE YOUR DATABASE!<br>Please run the follwoing query manually from PhpMyAdmin:</b><br><pre>$sql</pre><br>");
	...
	if (!does_field_exist("form_lists", "form_id")) {
		...
		mysql_query($sql) or die ("<p><b>CANNOT UPGRADE YOUR DATABASE!<br>Please run the follwoing query manually from PhpMyAdmin:</b><br><pre>$sql</pre><br>");
        $sql = "INSERT INTO `form_lists` VALUES (1, 'TEXT', 4, '2', 'URL', 4, 'N', 0, 'N', 'N', 'N', 'N', 'N')";
        mysql_query($sql) or die ("<p><b>CANNOT UPGRADE YOUR DATABASE!<br>Please run the follwoing query manually from PhpMyAdmin:</b><br><pre>$sql</pre><br>");
	}
