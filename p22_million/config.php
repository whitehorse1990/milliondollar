...
define('BASE_HTTP_PATH', 'http://localhost/p22_million/');
define('SERVER_PATH_TO_ADMIN', 'D:/PHP/Xampp/htdocs/p22_million/admin/');
define('UPLOAD_PATH', 'D:/PHP/Xampp/htdocs/p22_million/upload_files/');
define('UPLOAD_HTTP_PATH', 'http://localhost/p22_million/upload_files/');
define('MYSQL_HOST', 'localhost'); # mysql database host
define('MYSQL_USER', 'root'); #mysql user name
define('MYSQL_PASS', ''); # mysql password
define('MYSQL_DB', 'milliondollar_22_6'); # mysql database name
...
define('SITE_LOGO_URL', stripslashes('http://dev.vskytech.com/p22_milliondolar/img/logo.png'));

# SITE_NAME
# change to your website name
define('SITE_NAME', stripslashes('Million Dollar'));
